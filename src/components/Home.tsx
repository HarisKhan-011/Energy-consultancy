  ...
  return (
    <section className="relative pt-16 md:pt-24 pb-20">
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute top-0 left-1/4 h-[500px] w-[500px] rounded-full bg-[#2f80ed]/25 blur-[120px] animate-blob-drift" />
        <div
          className="absolute top-40 right-10 h-[400px] w-[400px] rounded-full bg-[#35d6ff]/20 blur-[120px] animate-blob-drift"
          style={{ animationDelay: "2s" }}
        />
        <div
          className="absolute bottom-0 right-1/3 h-[380px] w-[380px] rounded-full bg-[#ffb020]/10 blur-[120px] animate-blob-drift"
      ...
      <div className="container-90">
        <div className="grid gap-12 lg:grid-cols-[1.05fr_1fr] items-center">
          <div>
            <span
              className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full glass text-xs text-white/80 animate-fade-up"
            ...
            <h1
              className="mt-6 font-display text-5xl md:text-6xl lg:text-7xl font-bold leading-[1.02] tracking-tight text-white animate-fade-up"
              style={{ animationDelay: "100ms" }}
            >
              Smarter Gas & Electricity Services,{" "}
              <span className="text-gradient-tech animate-gradient-shift">
            ...
            >
              <a
                href="#services"
                className="btn-shine relative inline-flex items-center gap-2 px-6 py-3.5 rounded-xl bg-gradient-to-r from-[#2f80ed] to-[#35d6ff] text-white font-semibold shadow-[0_16px_50px_-15px_rgba(47,128,237,0.9)] hover:scale-[1.02] active:scale-[0.98] transition-transform"
              >
                Book a Service <ArrowRight className="h-4 w-4" />
              </a>
              <a
                href="#emergency"
                className="inline-flex items-center gap-2 px-6 py-3.5 rounded-xl glass border-[#ffb020]/30 text-white font-semibold hover:border-[#ffb020]/60 hover:bg-[#ffb020]/5 hover:scale-[1.02] active:scale-[0.98] transition-all"
              >
            ...
            <div
              className="mt-10 flex flex-wrap items-center gap-6 text-xs text-white/50 animate-fade-up"
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="mt-2.5 h-1 rounded-full bg-white/10 overflow-hidden">
                <div
                  className="h-full w-3/4 bg-gradient-to-r from-[#ffb020] to-[#ff6b3d] rounded-full animate-progress-fill"
        ...
        <div className="mt-3 p-4 rounded-2xl bg-white/[0.03] border border-white/5">
          ...
          <div className="mt-3 flex items-end gap-1.5 h-16">
            {[40, 55, 35, 70, 50, 65, 45].map((h, i) => (
              <div
                key={i}
                style={{ height: `${h}%`, animationDelay: `${500 + i * 80}ms` }}
                className="flex-1 rounded-t bg-gradient-to-t from-[#2f80ed] to-[#35d6ff] opacity-80 animate-bar-grow"
              />
            ))}
          </div>
        </div>
        ...
        <AnimateIn>
          <div className="glass rounded-3xl px-6 py-6 md:px-10">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-4">
              {items.map((s, i) => (
                <AnimateIn key={s.label} delay={i * 100} direction="up">
                  <div
...
function ServiceCard({ icon: Icon, title, desc, tint }: ServiceCardProps) {
  ...
  return (
    <div className="group relative glass rounded-2xl p-6 hover:border-white/20 hover:-translate-y-1.5 hover:shadow-[0_20px_50px_-20px_rgba(47,128,237,0.4)] transition-all duration-300">
      <div
      ...
      <div className="container-90">
        <AnimateIn>
          <div className="relative glass-strong rounded-3xl p-8 md:p-14 overflow-hidden">
            <div className="absolute -top-32 -right-32 h-96 w-96 rounded-full bg-[#ffb020]/15 blur-3xl animate-blob-drift" />
            <div
              className="absolute -bottom-32 -left-32 h-96 w-96 rounded-full bg-[#2f80ed]/15 blur-3xl animate-blob-drift"
              ...
              {steps.map((s, i) => (
                <AnimateIn key={s.label} delay={i * 120}>
                  <div className="relative">
                    ...
                    <div className="glass rounded-2xl p-5 h-full hover:border-[#35d6ff]/30 hover:-translate-y-1 transition-all duration-300">
            ...
            <div>
              ...
              <ul className="mt-6 space-y-3">
                {[
                  ...
                  <AnimateIn key={f} delay={i * 80} direction="left">
            ...
            <div className="glass-strong rounded-3xl p-6 md:p-7">
              ...
              <div className="mt-5 p-4 rounded-2xl bg-white/[0.03] border border-white/5">
                ...
                <div className="mt-2 h-2 rounded-full bg-white/10 overflow-hidden">
                  <div className="h-full w-[82%] rounded-full bg-gradient-to-r from-[#2f80ed] to-[#35d6ff] animate-progress-fill" />
                </div>
    ...
    <section id="about" className="py-20">
      <div className="container-90">
        ...
        <div className="mt-14 grid gap-5 lg:grid-cols-3">
          <AnimateIn delay={0} className="lg:row-span-2 lg:col-span-1">
            <div className="relative glass-strong rounded-3xl p-8 overflow-hidden h-full">
              ...
              <div className="relative">
                ...
                <p className="mt-4 text-sm text-white/70 leading-relaxed">
                  Track every job, technician, invoice, and safety certificate in one place. See
                  ETAs, chat with your crew, and export reports in a click.
                </p>
          ...
          <AnimateIn delay={300} className="lg:col-span-2">
            <div className="glass rounded-3xl p-6 flex items-center gap-6 h-full hover:border-white/20 hover:-translate-y-1 transition-all duration-300">
...
function FeatureCard({
  ...
  return (
    <div className="glass rounded-3xl p-6 hover:border-white/20 hover:-translate-y-1.5 hover:shadow-[0_16px_40px_-20px_rgba(47,128,237,0.35)] transition-all duration-300 h-full">
        ...
        <div className="mt-14 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
          {steps.map((s, i) => (
            <AnimateIn key={s.n} delay={i * 100}>
              <div className="relative glass rounded-2xl p-6 hover:border-white/20 hover:-translate-y-1 transition-all duration-300 h-full">
      ...
      <div className="container-90">
        <AnimateIn>
          <div className="relative glass-strong rounded-3xl p-10 md:p-16 overflow-hidden text-center">
            ...
            <div className="absolute -top-40 left-1/2 -translate-x-1/2 h-96 w-[600px] rounded-full bg-[#2f80ed]/25 blur-3xl animate-blob-drift" />
            <div
              className="absolute -bottom-40 right-1/4 h-80 w-80 rounded-full bg-[#ffb020]/15 blur-3xl animate-blob-drift"
            ...
            <div className="relative">
              ...
              <div className="mt-8 flex flex-wrap gap-3 justify-center">
                <a
                  href="#services"
                  className="btn-shine relative inline-flex items-center gap-2 px-7 py-3.5 rounded-xl bg-gradient-to-r from-[#2f80ed] to-[#35d6ff] text-white font-semibold shadow-[0_20px_50px_-15px_rgba(47,128,237,0.9)] hover:scale-[1.02] active:scale-[0.98] transition-transform"
                >
                  Book Now <ArrowRight className="h-4 w-4" />
                </a>
                <Link
                  to="/register"
                  className="inline-flex items-center gap-2 px-7 py-3.5 rounded-xl glass border-white/20 text-white font-semibold hover:bg-white/5 hover:scale-[1.02] active:scale-[0.98] transition-all"
                >
                  Create Account
                </Link>
              </div>
